...
export class UpdateOrganization1786954278847 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "organizations" ADD "status" character varying NOT NULL DEFAULT 'pending'`);
        ...
        await queryRunner.query(`ALTER TABLE "organizations" ADD "reviewed_at" TIMESTAMP WITH TIME ZONE`);
