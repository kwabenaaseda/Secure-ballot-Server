...
export class AddOtpCodes1787793980885 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "elections" ADD "results_status" character varying NOT NULL DEFAULT 'unreleased'`);
        await queryRunner.query(`ALTER TABLE "elections" ADD "results_released_at" TIMESTAMP WITH TIME ZONE`);
