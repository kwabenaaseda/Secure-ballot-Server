...
export async function GetSelf_Operation(params: { userId: string; network: NetworkContext }):Promise<Service_Success_Handler | Service_Error_Handler> {
  ...
  try {
    ...
    if (ops === false) {
      return await OPS_Error({
        ...
        message: 'Unable to resolve access profile.',
