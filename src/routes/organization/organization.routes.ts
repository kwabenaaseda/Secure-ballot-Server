...
import { CreateOrganization_Controller, Get_Org_Detail, Search_Org } from '../../controllers/organization/organization.controller'
...
Org_routes.get('/search/:query', AuthMiddleware, NetworkContextMiddleware, Search_Org)
